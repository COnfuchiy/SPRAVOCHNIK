...
class ApiHandler
{
    ...
    {
        return LoginComponent::checkAuth(
            function ($tokenUserId) use ($userId): Response {
    ...
    public static function getAllUsers(): Response
    {
        return LoginComponent::checkAuth(
            function (): Response {
                return ApiHelper::getAllRecords(
                    'Users::getAll()',
                    ApiHelper::USERS,
                    ApiHelper::getRecordsCount(ApiHelper::USERS)
                );
            }
        );
    }
        ...
        return LoginComponent::checkAuth(
            function ($userId): Response {
                return ApiHelper::getAllRecords(
                    ...
                    ApiHelper::NODES,
                    ApiHelper::getRecordsCount(ApiHelper::NODES, $userId, false)
                );
            }
        );
    }
    ...
    {
        return LoginComponent::checkAuth(
            function ($userId) use ($nodeId): Response {
                try {
    ...
    public static function getAllPublicNodes(): Response
    {
        return LoginComponent::checkAuth(
            function ($userId): Response {
                return ApiHelper::getAllRecords(
                    "Nodes::findPublicNodes",
                    ApiHelper::NODES,
                    ApiHelper::getRecordsCount(ApiHelper::NODES, true)
                );
            }
        );
    }
                ...
                if ($node) {
                    if ($node->user_id === $userId || $node->is_public) {
                        return ApiHelper::getAllRecords(
                            ...
                            ApiHelper::ADDRESSES,
                            ApiHelper::getRecordsCount(ApiHelper::ADDRESSES)
                        );
                    }
                    return ApiHelper::createErrorResponse(
                        ApiHelper::FORBIDDEN,
    ...
    {
        return LoginComponent::checkAuth(
            function ($userId) use ($addressId): Response {
                try {
                    ...
                    if ($address) {
                        ...
                        return ApiHelper::createErrorResponse(
                            ApiHelper::NOT_FOUND,
                            ["No find bound node in database"]
                        );
                    }
                    return ApiHelper::createErrorResponse(
                        ApiHelper::NOT_FOUND,
                        ["No find address in database"]
                    );
                } catch (Exception $exception) {
                    return ApiHelper::createErrorResponse(
                        ApiHelper::INTERNAL_SERVER_ERROR,
     ...
     * @return Response
     */
    public static function createAddress(int $nodeId): Response
    {
        return LoginComponent::checkAuth(
            function () use ($nodeId): Response {
                $request = new Request();
                $data = $request->getJsonRawBody();
                if ($data) {
                    try {
     ...
     * @return Response
     */
    public static function updateAddress(int $addressId): Response
    {
        return LoginComponent::checkAuth(
            function ($userId) use ($addressId): Response {
                $request = new Request();
     ...
     * @return Response
     */
    public static function deleteAddress(int $addressId): Response
    {
        return LoginComponent::checkAuth(
            function ($userId) use ($addressId): Response {
                try {
